...
public class FirebaseAddRecordActivity extends AppCompatActivity {
    Firebase firebase ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firebase_add_record);
    ...
    private void addRecordToFirebase() {
        if (id != null || !id.isEmpty() ||name != null || !name.isEmpty() ||
                ...
                firebase.addRecord(id, name, sureName, fatherName, nationalId, dob, gender);
        }
